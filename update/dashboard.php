            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-input py-2">
                <div class="col form-group">
                  <input type="text" class="form-control" placeholder="Candidate's Name" name="cand_name" required>
						    </div>
                
                <div class="col form-group">
                  <input type="text" class="form-control" placeholder="Contact number" name="cand_mob_no" required>
						    </div>
                
                <div class="col form-group">
                  <input type="email" class="form-control"placeholder="Candidate's email" name="cand_email" required>
						    </div>
                
                <div class="col form-group">
                  <input type="text" class="form-control" placeholder="Current Designation" name="cand_designation" required>
						    </div>
                
                <div class="col form-group">
                  <input type="text" class="form-control" placeholder="Candidate's Area of Expertise" name="cand_expert" required>
						    </div>
                
                <div class="col form-group">
                  <input type="text" class="form-control" placeholder="Total Experience" name="cand_exp" required>
						    </div>
                
                <div class="col form-group">
                  <input type="text" class="form-control" placeholder="Current CTC" name="cand_ctc" required>
						    </div>
                
                <div class="col form-group">
                  <input type="text" class="form-control" placeholder="Current Location" name="cand_location" required>
						    </div>
                
                <div class="col form-group">
                  <input type="text" class="form-control" placeholder="Current Organisation" name="cand_org" required>
						    </div>
                
                <div class="col form-group">
                  <input type="text" class="form-control" placeholder="Client Name" name="cand_client" required>
						    </div>
                
                <div class="col form-group">
                  <input type="date" class="form-control" placeholder="Submition Date" name="cand_subm_date" required>
						    </div>
                
                <div class="col form-group">
                  <input type="text" class="form-control"placeholder="Remarks" name="cand_remark" required>
						    </div>
                
                <div class="col form-group">
                  <input type="text" class="form-control" placeholder="Entered By" name="entered_by" required>
						    </div>
                  ...
                  if(!$employee_details) {
                    ...
                    foreach($employee_details as $key=>$value) {
                      ...
                      <tr>
                        ...
                        <td><a href="../uploadresume/downloads.php" class="btn btn-success">Download</a></td>
                      </tr>
                      <?php
                    }
                  }
