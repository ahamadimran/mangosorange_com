...
<head>
  ...
  <title>Search Resume | MangosOrange</title>
                ...
                <div class="col-lg-12">
                    ...
                    if(isset($_POST['save']))
                    {
                        if(!empty($_POST['search']) && !empty($_POST['search1']))
                        {
                            ...
                            $stmt = $con->prepare("select * from employee where cand_subm_date like '%$search%' and entered_by like '%$search1%'");
                            $stmt->execute();
                    ...
                    <form class="" action="#" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6 form-group">
                                <input type="date" class="form-control" name="search" placeholder="Select Date">
                            </div>
                            <div class="col-lg-6 form-group">
                                <input type="text" class="form-control" name="search1" placeholder="Entered By">
                            </div>
                                ...
                                if(!$employee_details)
                                {
                                    ...
                                    foreach($employee_details as $key=>$value)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value['cand_subm_date'];?></td>
                                            <td><?php echo $value['entered_by'];?></td>
